 ...
 *
 * Thin wrapper around `@packetflow/api-client` that maps backend DTOs to the
...
import { packagesApi, type BackendPackage, type CreatePackageInput, type UpdatePackageInput } from "@packetflow/api-client";
 ...
 */
export async function getPackageByCode(code: string, signal?: AbortSignal): Promise<Package | undefined> {
