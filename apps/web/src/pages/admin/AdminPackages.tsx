...
import { useCreateDelivery, useAssignTripToDelivery } from "@/api/hooks/useDeliveries";
import { useTrips, useCarrierUsers } from "@/api/hooks/useTrips";
import type { PackageView } from "@/api/packages";
import type { BackendTrip } from "@packetflow/api-client";
      ...
      <div className="space-y-1.5">
        ...
        {eligibleTrips.length === 0 ? (
          <p className="text-sm text-muted-foreground">
            No active trips available. Create a trip on the Routes page first.
          </p>
        ) : (
